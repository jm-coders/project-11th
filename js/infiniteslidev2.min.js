(function($){$(window).on('load',function(){window.loaded=!0});$(function(){$.fn.infiniteslide=function(options){var settings=$.extend({'speed':50,'direction':'left','pauseonhover':!0,'responsive':!1,'clone':1},options);var setCss=function(obj,direction){$(obj).wrap('<div class="infiniteslide_wrap"></div>').parent().css({overflow:'hidden'});if(direction=='up'||direction=='down'){var d='column'}else{var d='row'}
